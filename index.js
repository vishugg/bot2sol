...
function rndInt(min, max){
  ...
  let msg = '<b>⛔️ Must Join All Our Channel</b>\n============================<b>'
  for(var ind in channels){
  var cha = channels[ind]
  msg+='\n💠'+cha
  }
  msg+='\n</b>============================\n<b>🔰Follow Our Twitter Page</b>\n<b><a href="https://twitter.com/AirdropThumb">Airdrop Thumb</a></b>'
